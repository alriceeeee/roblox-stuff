...
--[[
	...
	modified by alriceee for remote firing support (no arguments are passed.)
	...
	The main explorer interface
		...
		local function main()
			...
			Explorer.InitRightClick = function()
                ...
                context:Register("FIRE_REMOTE", {Name = "Fire Remote", IconMap = Explorer.ClassIcons, Icon = 37, OnClick = function()
				...
				context:Register("FIRE_CLICKDETECTOR",{Name = "Fire ClickDetector", IconMap = Explorer.ClassIcons, Icon = 41, OnClick = function()
					for i,v in ipairs(selection.List) do
						if v.Obj and v.Obj:IsA("ClickDetector") then
							if v.Obj.MaxActivationDistance then
								fireclickdetector(v.Obj, v.Obj.MaxActivationDistance)
							else
				...
				context:Register("FIRE_PROXIMITYPROMPT",{Name = "Fire ProximityPrompt", IconMap = Explorer.ClassIcons, Icon = 124, OnClick = function()
					for i,v in ipairs(selection.List) do
						if v.Obj and v.Obj:IsA("ProximityPrompt") then
							...
							task.wait(v.Obj.HoldDuration + 0.01)
						end
					end
				end})
	...
	A script viewer that is basically a notepad
		...
		local function main()
			...
			ScriptViewer.ViewScript = function(scr)
                ...
                mainframe.Size, mainframe.Position, mainframe.BackgroundColor3, mainframe.Parent = UDim2.new(0.5, 0, 0.7, 0), UDim2.new(0.25, 0, 0.15, 0), Color3.fromRGB(25, 25, 35), screengui
                Instance.new("UICorner", mainframe).CornerRadius = UDim.new(0, 8)
            
                local title = Instance.new("TextLabel")
                title.Size, title.Position, title.BackgroundColor3, title.TextColor3, title.Font, title.Text, title.TextSize, title.Parent = UDim2.new(0.9, 0, 0.05, 0), UDim2.new(0, 0, 0, 0), Color3.fromRGB(30, 30, 40), Color3.fromRGB(220, 220, 220), Enum.Font.GothamBold, "Script Viewer", 16, mainframe
                title.Position = UDim2.new(0.05, 0, 0, 0)
                Instance.new("UICorner", title).CornerRadius = UDim.new(0, 6)
            
                local closebutton = Instance.new("TextButton")
                closebutton.Size, closebutton.Position, closebutton.BackgroundColor3, closebutton.Text, closebutton.TextSize, closebutton.Parent = UDim2.new(0.1, 0, 0.05, 0), UDim2.new(0.9, 0, 0, 0), Color3.fromRGB(45, 45, 55), "X", 14, mainframe
                ...
                viewer.Size, viewer.Position, viewer.BackgroundColor3, viewer.ScrollBarThickness, viewer.Parent = UDim2.new(0.98, 0, 0.83, 0), UDim2.new(0.01, 0, 0.11, 0), Color3.fromRGB(15, 15, 25), 6, mainframe
                Instance.new("UICorner", viewer).CornerRadius = UDim.new(0, 6)
            
                local scripttext = Instance.new("TextLabel")
                scripttext.AutomaticSize, scripttext.Position, scripttext.BackgroundTransparency, scripttext.TextColor3, scripttext.Text, scripttext.TextSize, scripttext.TextXAlignment, scripttext.TextYAlignment, scripttext.Font, scripttext.Parent = Enum.AutomaticSize.XY, UDim2.new(0, 5, 0, 0), 1, Color3.fromRGB(255, 255, 255), source:gsub("\0", "\\0"), 14, Enum.TextXAlignment.Left, Enum.TextYAlignment.Top, Enum.Font.Code, viewer
            
                local copybutton = Instance.new("TextButton")
                copybutton.Size, copybutton.Position, copybutton.BackgroundColor3, copybutton.Text, copybutton.TextSize, copybutton.Parent = UDim2.new(0.32, 0, 0.05, 0), UDim2.new(0.01, 0, 0.95, 0), Color3.fromRGB(45, 45, 55), "Copy to Clipboard", 14, mainframe
                copybutton.TextColor3 = Color3.fromRGB(255, 255, 255)
                Instance.new("UICorner", copybutton).CornerRadius = UDim.new(0, 6)
            
                local savebutton = Instance.new("TextButton")
                savebutton.Size, savebutton.Position, savebutton.BackgroundColor3, savebutton.Text, savebutton.TextSize, savebutton.Parent = UDim2.new(0.32, 0, 0.05, 0), UDim2.new(0.34, 0, 0.95, 0), Color3.fromRGB(45, 45, 55), "Save to File", 14, mainframe
                savebutton.TextColor3 = Color3.fromRGB(255, 255, 255)
                Instance.new("UICorner", savebutton).CornerRadius = UDim.new(0, 6)
            
                local dumpbutton = Instance.new("TextButton")
                dumpbutton.Size, dumpbutton.Position, dumpbutton.BackgroundColor3, dumpbutton.Text, dumpbutton.TextSize, dumpbutton.Parent = UDim2.new(0.32, 0, 0.05, 0), UDim2.new(0.67, 0, 0.95, 0), Color3.fromRGB(45, 45, 55), "Dump Functions", 14, mainframe
                dumpbutton.TextColor3 = Color3.fromRGB(255, 255, 255)
                Instance.new("UICorner", dumpbutton).CornerRadius = UDim.new(0, 6)
            
                copybutton.MouseButton1Click:Connect(function()
                    env.setclipboard(scripttext.Text)
                ...
                savebutton.MouseButton1Click:Connect(function()
                    ...
                    env.writefile(filename, scripttext.Text)
                    ...
                    if PreviousScr ~= nil then
                        pcall(function()
                            ...
                            if dump ~= original then 
                                scripttext.Text = scripttext.Text .. dump .. "]]" 
                            end
                            viewer.CanvasSize = UDim2.new(0, scripttext.TextBounds.X + 10, 0, scripttext.TextBounds.Y + 10)
                        end)
                    end
                end)
            ...
            ScriptViewer.Init = function() end
...
{2,"TextButton",{AnchorPoint=Vector2.new(0.5,0),AutoButtonColor=false,BackgroundColor3=Color3.new(0.17647059261799,0.17647059261799,0.17647059261799),BackgroundTransparency=0.4,BorderSizePixel=0,Font=4,Name="OpenButton",Parent={1},Position=UDim2.new(0.5,0,0,2),Size=UDim2.new(0,32,0,32),Text="Dex",TextColor3=Color3.new(1,1,1),TextSize=16,TextTransparency=0.2,}},
{3,"UICorner",{CornerRadius=UDim.new(0,4),Parent={2},}},
{4,"Frame",{AnchorPoint=Vector2.new(0.5,0),BackgroundColor3=Color3.new(0.17647059261799,0.17647059261799,0.17647059261799),BackgroundTransparency=0.4,ClipsDescendants=true,Name="MainFrame",Parent={2},Position=UDim2.new(0.5,0,1,-4),Size=UDim2.new(0,224,0,200),}},
{5,"UICorner",{CornerRadius=UDim.new(0,4),Parent={4},}},
{6,"Frame",{BackgroundColor3=Color3.new(0.20392157137394,0.20392157137394,0.20392157137394),BackgroundTransparency=0.4,Name="BottomFrame",Parent={4},Position=UDim2.new(0,0,1,-24),Size=UDim2.new(1,0,0,24),}},
...
{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BackgroundTransparency=0.4,BorderSizePixel=0,Font=3,Name="Main",Parent={17},Size=UDim2.new(1,0,0,60),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
